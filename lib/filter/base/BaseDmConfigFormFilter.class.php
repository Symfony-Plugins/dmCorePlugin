...
/**
 * DmConfig filter form base class.
 *
 ...
 */
class BaseDmConfigFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'external_link_blank' => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
      ...
      'index_optimized_at'  => new sfWidgetFormFilterDate(array('from_date' => new sfWidgetFormDate(), 'to_date' => new sfWidgetFormDate(), 'with_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'external_link_blank' => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
      ...
      'index_optimized_at'  => new sfValidatorDateRange(array('required' => false, 'from_date' => new sfValidatorDate(array('required' => false)), 'to_date' => new sfValidatorDate(array('required' => false)))),
      'updated_at'          => new sfValidatorDateRange(array('required' => false, 'from_date' => new sfValidatorDate(array('required' => false)), 'to_date' => new sfValidatorDate(array('required' => false)))),
    ));

    $this->widgetSchema->setNameFormat('dm_config_filters[%s]');
  ...
  public function getFields()
  {
    return array(
      ...
      'external_link_blank' => 'Boolean',
      'is_working_copy'     => 'Boolean',
      'index_populated_at'  => 'Date',
      'index_optimized_at'  => 'Date',
      'updated_at'          => 'Date',
      'id'                  => 'Number',
    );
  }
